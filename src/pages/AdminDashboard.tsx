...
function UsersView() {
  ...
  const [formData, setFormData] = useState({ name: "", email: "", password: "", role: "cleaner" });
    ...
    <div className="max-w-5xl mx-auto">
      ...
      {showForm && (
        <div className="bg-white p-8 md:p-12 retro-border retro-shadow mb-12">
          <h2 className="text-2xl font-serif mb-8 font-bold text-[#2A2522]">Nový uživatel</h2>
          <form onSubmit={handleSubmit} className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div>
              ...
              <input type="password" value={formData.password} onChange={e => setFormData({...formData, password: e.target.value})} className={inputClasses} required />
            </div>
            <div>
